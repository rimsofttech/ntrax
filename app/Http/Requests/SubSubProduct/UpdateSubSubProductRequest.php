...
class UpdateSubSubProductRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
        ...
        return policy(SubSubProduct::class)->update($this->user());
    }
    ...
    public function rules()
    {
        // dd($this->zone);
        return [
            'name' => 'required|min:3|max:35|regex:/^([a-zA-Z\' ])*$/|unique:sub_sub_products,name,'.$this->request->get("hidden_id"),
